...
# Generated by Powerlevel10k configuration wizard on 2024-05-23 at 16:29 IDT.
...
# omzplug clone Deep-Tech-Showcase-Eaglepoint-Funding/anyenv-full-autoupdate
# omzplug clone TamCore/autoupdate-oh-my-zsh-plugins
# omzplug clone zdharma-continuum/fast-syntax-highlighting
# omzplug clone Pilaton/OhMyZsh-full-autoupdate
# omzplug clone Deep-Tech-Showcase-Eaglepoint-Funding/pyenv-full-autoupdate
# omzplug clone davidparsson/zsh-pyenv-lazy
# omzplug clone zsh-users/zsh-autosuggestions
# omzplug clone marlonrichert/zsh-autocomplete
# omzplug clone 3v1n0/zsh-bash-completions-fallback
# omzplug clone zsh-users/zsh-syntax-highlighting
# omzplug clone qoomon/zsh-lazyload
...
# omz plugin enable git-auto-fetch
# omz plugin enable zsh-autosuggestions
# omz plugin enable python
# omz plugin enable sudo
# omz plugin enable aliases
# omz plugin enable zsh-syntax-highlighting
# omz plugin enable archlinux
# omz plugin enable pip
# omz plugin enable pyenv
# omz plugin enable ohmyzsh-full-autoupdate
# omz plugin enable zsh-lazyload
# omz plugin enable systemd
# omz plugin enable zsh-interactive-cd
# omz plugin enable anyenv-full-autoupdate
# omz plugin enable zsh-completions
#
#
#
#
# omz plugin enable zsh-bash-completions-fallback

omz plugin enable git git-auto-fetch zsh-autosuggestions python sudo aliases zsh-syntax-highlighting archlinux pip pyenv ohmyzsh-full-autoupdate zsh-lazyload systemd zsh-interactive-cd anyenv-full-autoupdate omzplug zsh-completions
